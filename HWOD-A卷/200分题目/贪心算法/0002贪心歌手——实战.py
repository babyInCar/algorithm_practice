...
def max_profit(T, N, travel_costs, city_info):
    ...
    pq = []
    for i, (M, D) in enumerate(city_info):
        heapq.heappush(pq, (-M, D))
    res = 0
    while remaining_days > 0:
        income, decrease = heapq.heappop(pq)
        income = - income
        res += income
        new_income = income - decrease
...
if __name__ == '__main__':
    ...
    print(max_profit(T, N, travel_costs, city_info))